...
%%% 测量电子分布的设置
Sample.distribute_EF = linspace(-0.1,1.1,1000);
Sample.distribute_num_site = 10;
%============%耗散和无序的设置
Stochastic.dissipation.str = -1i/2*0.02*Sample.t;%strength of dissipation%%SIGMA
Stochastic.dissipation.dens = 1;%density of dephasing sites
