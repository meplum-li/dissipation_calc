function [TeffRL,Voltage_real] = dissipation(EF)
    tic
    ...
    [GAMMAlead_left,GAMMAlead_right,SIGMAlead_left,SIGMAlead_right] = lead( EF, Sample.phiz, Lattice );
    ...
    gri_i = inv( EF * speye( N_nu( 1 ) ) - H00{ 1 } );
    grlead_i = gri_i;
    gri_lead = gri_i;
    grlead_lead = gri_i;
    ...
    for ii = 2:Nslice
        ...
        tem_gri_i = inv( EF * speye( nii ) - H00{ ii } - H01{ mod( ii, 2 ) + 1 }' * tem_gri_i * H01{ mod( ii, 2 ) + 1 } );
